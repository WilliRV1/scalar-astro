          ...
          <form onSubmit={sendCode} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 bg-gray-100 p-3 text-center text-lg tracking-widest focus:border-primary focus:outline-none dark:border-gray-700 dark:bg-black"
              />
          ...
          <form onSubmit={verify} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 bg-gray-100 p-3 text-center text-2xl tracking-[0.5em] focus:border-primary focus:outline-none dark:border-gray-700 dark:bg-black"
              />
            </div>
            {error && <ErrorNote>{error}</ErrorNote>}
            <Button type="submit" disabled={busy} className="w-full">
